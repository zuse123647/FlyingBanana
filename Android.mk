...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"FlyingBanana"' -DVERSION='"0.1.0"' -I'./shared' -I'./extern' -isystem'extern/monkecodegen/include'
